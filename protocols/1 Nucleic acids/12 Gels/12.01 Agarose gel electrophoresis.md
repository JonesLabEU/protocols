...
![Source: Extraction, Modification and Biomedical Application of Agarose Hydrogels: A Review (https://www.mdpi.com/1660-3397/21/5/299)](../../assets/image-019.png)
...
7. *(Optional)* Add **5 uL** of [SYBR Safe](12.06%20Staining.md#SYBR) to **prestain**.
...
2. Mix with a [loading dye](12.04%20Loading%20dyes.md) at the required proportion.
3. Choose an appropriate [ladder](12.05%20Ladders.md).
