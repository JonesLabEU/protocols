...
6. **Prepare samples**. Make sure to use most wells as otherwise bands might get distorted.
	...
	- **2.5 uL ladder:** [index](12.05%20Ladders.md)
7. For **denaturing** gels, **heat** the samples and the ladders as specified in [index](12.04%20Loading%20dyes.md)
...
11. Proceed to [Staining](12.06%20Staining.md).

## Troubleshooting
### Uneven bands
See lane 5 with a jagged ladder:
![400](../../assets/image-024.jpg)
