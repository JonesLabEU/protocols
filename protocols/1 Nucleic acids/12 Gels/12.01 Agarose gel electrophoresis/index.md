...
3. **Microwave for ~2 min with the bottle cap only losely holding** until the agarose is completely dissolved.
...
5. *(Optional)* Add **5 uL** of SYBR Safe to **prestain**.
...
8. Place newly poured gel at 4°C for 10-15 mins OR let sit at room temperature for 20-30 mins, until it has completely **solidified**.
